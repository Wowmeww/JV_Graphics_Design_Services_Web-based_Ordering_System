<script setup>
    ...
    const styleClass = {
        container: 'flex relative w-full mx-auto max-w-sm overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800',
...
<template>
    <Transition name="fade">
        <div v-if="status" :class="styleClass.container">
