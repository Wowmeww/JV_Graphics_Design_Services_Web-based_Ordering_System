...
<template>
    <div
        class="flex items-center hover:bg-gray-100 dark:hover:bg-gray-800 justify-between p-3 rounded-md transition-all duration-200">
        <div class="flex items-center space-x-3 flex-1">
            <!-- Product Image -->
            <img :src="image_url" alt="Product Image" class="w-12 h-12 object-cover rounded-md shadow-sm">

            <div>
                <p class="font-medium dark:text-gray-300">{{ product.name }}</p>
        ...
        <!-- Rating Number -->
        <div class="ml-3 font-bold text-lg text-yellow-400">
