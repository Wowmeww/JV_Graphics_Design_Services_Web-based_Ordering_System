...
<template>
    <div v-if="expanded"
        class="fixed inset-0 z-30 bg-secondary/20 backdrop-blur-xs transition dark:bg-black/30 dark:backdrop-blur-xs"
        @click="close">
    </div>
    ...
    <aside :class="[
        ...
        <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800 space-y-2 font-medium">
            <AuthAsideLink :active="page.component === 'Dashboard'" :routeName="route('dashboard')">
            ...
            <AuthAsideLink v-if="is_admin" :routeName="route('dashboard')">
                <svg :class="styleClass.icon" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                    viewBox="0 0 20 18">
                    <path
            ...
            <AuthAsideLink v-if="is_admin" :active="page.component === 'product/Index'"
                :routeName="route('product.index')">
                <svg :class="styleClass.icon" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                    viewBox="0 0 18 20">
                    <path
