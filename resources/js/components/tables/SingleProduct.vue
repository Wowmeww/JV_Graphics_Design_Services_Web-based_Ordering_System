...
<template>
    <div
        class="container-primary w-full min-w-fit rounded-xl bg-white p-4 text-wrap transition duration-1000 dark:bg-[#1e293b]"
    ...
    >
        ...
        <Transition name="expand">
            <div v-if="expanded" class="mt-4 space-y-3">
                ...
                <div class="flex items-center justify-between">
                    <span>Size</span>
                    <span v-if="product.show_size" class="font-semibold">{{ product.show_size }}</span>
                </div>
                <div class="flex items-center justify-between">
                    <span>Stock</span>
