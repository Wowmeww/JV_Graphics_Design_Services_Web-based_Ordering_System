...
<template>
    ...
    <div class="fixed z-50 w-full bg-white p-2 sm:hidden dark:bg-slate-900">
        <button
    ...
    <div>
            ...
            <div class="h-full overflow-y-auto px-3 py-4">
                <div class="space-y-2 font-medium">
                    ...
                    <Link
                        ...
                        as="button"
                        :class="component == 'profile/SystemSettings' ? [styleClass.asideLink, styleClass.asideLinkActive] : styleClass.asideLink"
                    >
        ...
        <!-- Main Content -->
        <div class="p-4 pt-20 sm:ml-64 sm:pt-4">
            <slot />
        </div>
    </div>
</template>
