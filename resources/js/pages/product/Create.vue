...
<template>
    ...
    <div class="mx-auto flex max-w-7xl justify-center px-2 pt-10 md:justify-end">
        <Link
            as="button"
            :href="route('customize.create')"
            class="btn from-secondary-500 hover:from-secondary to-primary-500 hover:to-primary w-full gap-4 bg-linear-65 text-white transition md:w-max"
        >
            <span> Create a Customizable Product </span>
            <i class="fa-solid fa-circle-plus text-xl"></i>
        </Link>
    </div>
    <form class="mx-auto max-w-7xl space-y-3 px-2 py-10 md:space-y-8" @submit.prevent="submit">
        ...
        <ContainerPrimary title="Product Setting">
            ...
            <div class="mx-auto grid max-w-3xl gap-3 py-6 pt-8 sm:grid-cols-3">
