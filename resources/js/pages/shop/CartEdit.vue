...
const styleClass = {
    ...
    stockText: 'text-xs font-semibold',
            ...
            <div :class="styleClass.mainCard">
                ...
                <div :class="styleClass.productLayout">
                    ...
                    <div :class="styleClass.productDetails">
                            ...
                            <div :class="styleClass.productInfo">
                                <div :class="styleClass.productTitleRow">
                                    <div :class="styleClass.productTitleSection">
                                        ...
                                        <small :class="[styleClass.stockBadge, product.stock > 20 ? styleClass.stockIn : styleClass.stockLow]"
                        ...
                        <!-- Reviews Section -->
                        <div v-if="product.ratings?.length" :class="styleClass.reviewsSection">
                            <div class="space-y-3">
